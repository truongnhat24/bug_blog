...
<head>
    ...
    <link rel="stylesheet" href="<?php echo RootREL; ?>media/css/add_blog.css">
</head>
<body class="h-100">
    <?php if (isset($_SESSION['auth'])) { 
        ...
        <section class="set-background">
            <section class="container bg-light ">
                ...
                <form name="add_blog" class="p-3" action="<?php echo html_helpers::url(
                        array('ctl'=>'blogs',
                            'act'=>'createSubmit',
                            'params'=>$params
                        )); ?>" method="post">
                    ...
                    <div class="row mb-3 flex-column">
                        ...
                        <div class="col-sm-10 image-upload">
                            ...
                            <img <?php  if (!empty($data['image'])) {
                                        ...
                                        } else { ?> src="<?php echo RootREL;?>media/img/avatar_default.png" alt='default' <?php }?>
                            class="img-thumbnail profile-image" name="data[<?php echo $this->controller; ?>][image]">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div>
                            <textarea name="data[<?php echo $this->controller; ?>][content-blog]" id="content-blog"></textarea>
                        </div>
                    </div>
